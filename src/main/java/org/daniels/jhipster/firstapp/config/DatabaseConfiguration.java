...
@Configuration
@EnableJpaRepositories("org.daniels.jhipster.firstapp.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "org.daniels.jhipster.firstapp.config.HerokuDatabaseConfiguration")
